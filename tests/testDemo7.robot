...
Play around with Dictinoary
    [Tags]      API
    &{data}=         SET TO DICTIONARY       name=rahulshetty     course=robot       website=rahulshettyacademy.com
    log     ${data}
...
Delete the Book from database
       ...
       should contain match   book is successfully deleted    ${delete_resp.json()}[msg]
